(function ($) {
	...
	// getquote Js
	var $getquoteWrap = $('.getquote-wrap');
	var $navGetquote = $('.getquote-trigger');
	var $getquoteClose = $('#getquote-close');

	$('.getquote-trigger').on('click', function (e) {
		e.preventDefault();
		$getquoteWrap.animate({ opacity: 'toggle' }, 500);
		$navGetquote.add($getquoteClose).addClass("open");
	});

	$('.getquote-close').on('click', function (e) {
		e.preventDefault();
		$getquoteWrap.animate({ opacity: 'toggle' }, 500);
		$navGetquote.add($getquoteClose).removeClass("open");
	});

	function closeGetquote() {
		$getquoteWrap.fadeOut(200);
		$navGetquote.add($getquoteClose).removeClass("open");
	}
